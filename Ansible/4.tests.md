...
- 📁 nginx
  - 📁 [goup_vars](#group_vars)
    - 📄 all
  - 📁 inventory
    - 📄 hosts.ini
  - 📄 main.yml
  - 📁 roles
      - 📁 [register_var](#register_vartasksmainyml)
        - 📁 tasks
          - 📄 main.yml
      - 📁 [conditions](#conditionstasksmainyml)
        - 📁 tasks
          - 📄 main.yml
      - 📁 [fail_force](#fail_forcetasksmainyml)
        - 📁 tasks
          - 📄 main.yml
      - 📁 [ignore_errors](#ignore_errorstasksmainyml)
        - 📁 tasks
          - 📄 main.yml
      - 📁 [template_var](#template_vartasksmainyml)
        - 📁 tasks
          - 📄 main.yml
        -  📁 templates
            - 📄 index.html.j2
